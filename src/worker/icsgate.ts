...
//
// The odd one out among the connectors, and the one the Globex calendar actually needs: there is no
    ...
    blocks: [
      {
        ...
        element: {
          ...
          action_id: "value",
          placeholder: { type: "plain_text", text: "globex" },
        },
        hint: { type: "plain_text", text: "A short name you will recognise: work, globex, personal." },
      },
      {
        type: "input",
        block_id: "url",
