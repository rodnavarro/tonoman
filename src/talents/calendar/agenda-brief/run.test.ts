...
describe('agenda-brief run', () => {
  it('reads today in the tenant zone and steers with the overlap', async () => {
    ...
    const { c, calendarEvents, infer } = ctx([ev('Globex review', '10:00', '11:00'), ev('Vendor call', '10:30', '11:30')]);
    ...
    expect(out.steer).toContain('“Globex review” and “Vendor call” collide for 30 min from 10:30');
